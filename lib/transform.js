...
function transform(rows, dropReasons = []) {
  ...
  return rows
    ...
    // Step 24: every row must have an approved collection tag. Exceptions are
    // 18CT wedding rings from any collection, 9CT/18CT A.Girard wedding rings,
    // and Rings in the MRM 750 or MRM 750Emp collections.
    .filter(trackDrop(
