...
// Minimum columns to update descriptions on existing Shopify products without
// touching inventory, pricing, or images. Option columns are required so Shopify
// can match each row to the correct variant; omitting them would delete all variants.
      ...
      complete: ({ data }) => {
        ...
        setTimeout(() => {
          try {
            ...
            // Description-only update files: all variant rows, 7 columns.
