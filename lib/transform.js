...
function transform(rows, dropReasons = []) {
  ...
  return rows
    ...
    // 18CT wedding rings from any collection and 9CT/18CT A.Girard wedding rings.
    .filter(trackDrop(
      'collection_not_approved',
      'Product is not in an approved collection or an eligible wedding-ring exception',
